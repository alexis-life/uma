export const RACE_PLANS = {
  Nige: 'Take the lead from the gate and hold it wire-to-wire. Spend early stamina to open a gap before the pack settles, then manage pace carefully down the backstretch — a Nige runner has nowhere to hide if it gets caught, so stamina and positioning skills that protect the lead matter more than raw late-race power.',
  Senkou: 'Sit just off the leaders in second or third, conserving stamina while the Nige runner burns theirs. Time the move around the final corner: too early and you fade, too late and you run out of track. Positioning skills that secure a clean lane matter as much as speed stats.',
